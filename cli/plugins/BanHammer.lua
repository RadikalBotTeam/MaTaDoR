--Begin BanHammer.lua By @sudoradical
...
user_name = check_markdown(data.first_name_)
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "*شما نمیتولغوید مدیرلغو،صاحبلغو گروه، و ادمین های ربات رو از گروه محروم کنید*", 0, "md")
         end
     end
...
user_name = check_markdown(data.first_name_)
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "*شما نمیتولغوید تولغوایی چت کردن رو از مدیرلغو،صاحبلغو گروه، و ادمین های ربات بگیرید*", 0, "md")
       end
     end
if administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] then
    if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *از قبل تولغوایی چت کردن رو نداشت*", 0, "md")
     end
   end
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] = user_name
  ...
  if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *تولغوایی چت کردن رو از دست داد*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
if not administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] then
   if not lang then
    ...
    return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *از قبل تولغوایی چت کردن را داشت*", 0, "md")
      end
   end
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] = nil
    ...
    if not lang then
     ...
     return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *تولغوایی چت کردن رو به دست آورد*", 0, "md")
   end
end
tdcli_function ({
    ID = "GetUser",
...
user_name = check_markdown(data.first_name_)
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "*شما نمیتولغوید ادمین های ربات رو از تمامی گروه های ربات محروم کنید*", 0, "md")
        end
     end
if is_gbanned(data.id_) then
   if not lang then
...
tdcli_function ({
  ...
  return tdcli.sendMessage(data.chat_id_, "", 0, "_You can't kick_ *mods,owners and bot admins*", 0, "md")
    elseif lang then
  return tdcli.sendMessage(data.chat_id_, "", 0, "*شما نمیتولغوید مدیرلغو،صاحبلغو گروه و ادمین های ربات رو اخراج کنید*", 0, "md")
   end
  else
  ...
  return tdcli.sendMessage(data.chat_id_, "", 0, "_You can't delete messages_ *mods,owners and bot admins*", 0, "md")
   elseif lang then
  return tdcli.sendMessage(data.chat_id_, "", 0, "*شما نمیتولغوید پیام های مدیرلغو،صاحبلغو گروه و ادمین های ربات رو پاک کنید*", 0, "md")
   end
  else
...
if not is_gbanned(data.id_) then
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "_You can't kick_ *mods,owners and bot admins*", 0, "md")
    elseif lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "*شما نمیتولغوید مدیرلغو،صاحبلغو گروه و ادمین های ربات رو اخراج کنید*", 0, "md")
   end
  else
     kick_user(data.id_, arg.chat_id)
     end
  ...
  return tdcli.sendMessage(arg.chat_id, "", 0, "_You can't delete messages_ *mods,owners and bot admins*", 0, "md")
   elseif lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "*شما نمیتولغوید پیام های مدیرلغو،صاحبلغو گروه و ادمین های ربات رو پاک کنید*", 0, "md")
   end
  else
...
user = msg.from.id
   if msg.to.type ~= 'pv' then
 if matches[1] == "kick" and is_mod(msg) or matches[1] == "Kick" and is_mod(msg) or matches[1] == "اخراج" and is_mod(msg) then
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   elseif lang then
     tdcli.sendMessage(msg.to.id, "", 0, "*شما نمیتولغوید مدیرلغو،صاحبلغو گروه و ادمین های ربات رو اخراج کنید*", 0, "md")
         end
     else
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   return tdcli.sendMessage(msg.to.id, "", 0, "_You can't delete messages mods,owners or bot admins_", 0, "md")
     elseif lang then
   return tdcli.sendMessage(msg.to.id, "", 0, "*شما نمیتولغوید پیام های مدیرلغو،صاحبلغو گروه و ادمین های ربات رو پاک کنید*", 0, "md")
   end
     else
tdcli.deleteMessagesFromUser(msg.to.id, matches[2], dl_cb, nil)
 ...
 if matches[1] == "banall" and is_admin(msg) or matches[1] == "Banall" and is_admin(msg) or matches[1] == "مسدودگلوبال" and is_admin(msg) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   if not lang then
    ...
    return tdcli.sendMessage(msg.to.id, "", 0, "*شما نمیتولغوید ادمین های ربات رو از گروه های ربات محروم کنید*", 0, "md")
        end
     end
...
kick_user(matches[2], msg.to.id)
 ...
 if matches[1] == "unbanall" and is_admin(msg) or  matches[1] == "Unbanall" and is_admin(msg) or  matches[1] == "لغو گلوبال" and is_admin(msg) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   if is_mod1(msg.to.id, matches[2]) then
    ...
    return tdcli.sendMessage(msg.to.id, "", 0, "*شما نمیتولغوید مدیرلغو،صاحبلغو گروه و ادمین های ربات رو از گروه محروم کنید*", 0, "md")
        end
     end
...
kick_user(matches[2], msg.to.id)
 ...
 if matches[1] == "unban" and is_mod(msg) or matches[1] == "Unban" and is_mod(msg) or matches[1] == "لغو مسدود" and is_mod(msg) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   return tdcli.sendMessage(msg.to.id, "", 0, "*شما نمیتولغوید تولغوایی چت کردن رو از مدیرلغو،صاحبلغو گروه و ادمین های ربات بگیرید*", 0, "md")
        end
     end
   ...
   return tdcli.sendMessage(msg.to.id, "", 0, "*کاربر "..matches[2].." از قبل تولغوایی چت کردن رو نداشت*", 0, "md")
        end
     end
data[tostring(chat)]['is_silent_users'][tostring(matches[2])] = ""
 ...
 return tdcli.sendMessage(msg.to.id, msg.id, 0, "*کاربر "..matches[2].." تولغوایی چت کردن رو از دست داد*", 0, "md")
      end
   end
  if matches[2] and not string.match(matches[2], '^%d+$') then
    tdcli_function ({
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   if not is_silent_user(matches[2], chat) then
     ...
     return tdcli.sendMessage(msg.to.id, "", 0, "*کاربر "..matches[2].." از قبل تولغوایی چت کردن رو داشت*", 0, "md")
        end
     end
data[tostring(chat)]['is_silent_users'][tostring(matches[2])] = nil
 ...
 return tdcli.sendMessage(msg.to.id, msg.id, 0, "*کاربر "..matches[2].." تولغوایی چت کردن رو به دست آورد*", 0, "md")
      end
   end
  if matches[2] and not string.match(matches[2], '^%d+$') then
   tdcli_function ({
     ...
     if not lang then
				...
				return "*تمام کاربرلغو محروم شده از گروه از محرومیت خارج شدند*"
           end
			end
        ...
        if not lang then
					...
					return "*لیست کاربرلغو سایلنت شده خالی است*"
             end
				end
       ...
       if not lang then
				...
				return "*لیست کاربرلغو سایلنت شده پاک شد*"
               end
			    end
        end
     end
    ...
    if not lang then
      ...
      if not lang then
				...
				return "*تمام کاربرلغوی که از گروه های ربات محروم بودند از محرومیت خارج شدند*"
          end
			end
     end
if matches[1] == "gbanlist" and is_admin(msg) or  matches[1] == "Gbanlist" and is_admin(msg) or  matches[1] == "لیست مسدودگلوبال" and is_admin(msg) then
